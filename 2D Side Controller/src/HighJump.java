...
/**
 * Class used to make main hero jump high.
 */
public class HighJump implements IJump
{
    ...
    public HighJump(int worldHeight, int heroHeight, Point virtualCoord, Point realCoord)
    {
        this.worldHeight = worldHeight;
        this.heroHeight = heroHeight;
        MAX_JUMP_HEIGHT = worldHeight - (worldHeight*9/10);
